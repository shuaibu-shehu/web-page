...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Please try again, or email us directly at contact@codetherapy.ml.",
        variant: "destructive",
      });
    } finally {
      setSending(false);
  ...
  return (
    <main className="bg-cream">
      {/* ---------------------------------------------------------- hero */}
      <section className="shell flex flex-col gap-6 pb-16 pt-20">
      ...
      {/* -------------------------------------------------- form + panel */}
      <section className="shell flex flex-col gap-16 pb-24 lg:flex-row">
        <div className="flex-1 rounded-2xl bg-white p-6 drop-shadow-[0px_8px_12px_rgba(30,34,41,0.04)] md:p-10">
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-6">
            ...
            <button
              type="submit"
              disabled={sending}
              className="btn-sage w-full disabled:opacity-60"
            >
      ...
      <section className="border-t border-line">
        <div className="shell flex flex-col gap-12 pb-24 pt-20">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {quickAnswers.map((item) => (
              ...
              >
                <h3 className="font-serif text-xl font-semibold text-clay">
                  {item.q}
                </h3>
