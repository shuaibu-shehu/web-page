...
export default async function AdminSettingsPage() {
  ...
  const settings = {
    ...
    primaryAccent: get("primaryAccent", "#4A7C59"),
    secondaryAccent: get("secondaryAccent", "#C2703E"),
    standardLogo: get("standardLogo", "/v2/logo-mark.png"),
    darkModeLogo: get("darkModeLogo", "/v2/logo-mark.png"),
